...
*   **Insufficient Sample Size:** Training a parameter-heavy model (3D CNN + Mamba) on roughly 75 subjects **poses a significant risk of overfitting**. While such sample sizes are common in clinical studies, deep learning models typically require larger datasets or extensive pre-training to learn robust generalized features.
