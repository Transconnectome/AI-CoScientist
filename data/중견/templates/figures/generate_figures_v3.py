#!/usr/bin/env python3
"""
NRF 중견연구 제안서 Figure 생성 스크립트 (v3)

발달-노화 궤적 예측 멀티모달 파운데이션 모델
- Figure 1: 문제-갭-가설-기여 개요도
- Figure 2: 50B LifeSpan-FM 아키텍처 (수정)
- Figure 3: 데이터 파이프라인
- Figure 4: 5년 로드맵
...
# ============================================================================
# Figure 2: 50B LifeSpan-FM Architecture (Updated from 300B)
# ============================================================================
def generate_figure2_architecture():
    """50B 멀티모달 파운데이션 모델 아키텍처"""
    ...
    # ===== ENCODER 계층 (50B = 15B x 3 + 500M) =====
    ax.text(7, 9.5, 'MODALITY-SPECIFIC FM (50B Total)', fontsize=11,
            fontweight='bold', ha='center')
    ...
    # ===== FUSION 계층 (500M Q-Former) =====
    draw_rounded_box(ax, 7.0, 5.8, 3.0, 1.2, 'Q-Former Fusion (500M)\nCross-Modal Attention\nBLIP-2/CROME Style',
    ...
    # 스케일 비교 박스
    ax.add_patch(Rectangle((0.3, 0.6), 4.5, 0.8, fill=True,
                           facecolor='#fff3e0', edgecolor='#ff6f00', linewidth=1.5))
    ax.text(2.55, 1.2, 'Scale Comparison', fontsize=9, fontweight='bold', ha='center')
    ax.text(2.55, 0.85, 'BrainLM: 3-8B | This Study: 50B (6-15x larger)', fontsize=8, ha='center')

    # 제목
    ax.text(7, 0.15, 'Figure 2. LifeSpan-FM: 50B Multimodal Foundation Model Architecture',
            fontsize=12, fontweight='bold', ha='center', style='italic')

    plt.tight_layout()
    plt.savefig('fig2_model_architecture_v3.png', dpi=300, bbox_inches='tight',
                facecolor='white', edgecolor='none')
    plt.savefig('fig2_model_architecture_v3.pdf', bbox_inches='tight',
                facecolor='white', edgecolor='none')
    print("Figure 2 saved: fig2_model_architecture_v3.png/pdf")
    plt.close()


# ============================================================================
# Figure 1: Problem-Gap-Hypothesis-Contribution (Updated)
# ============================================================================
def generate_figure1_overview():
    ...
    ax.text(5.3, 6.2, '- Scale gap (3-8B vs 50B)', fontsize=8, ha='center')
    ...
    ax.text(12.2, 7.0, '50B Trajectory FM', fontsize=9, ha='center', style='italic')
    ax.text(12.2, 6.5, '- fMRI/EEG/Genomic 15B each', fontsize=8, ha='center')
    ...
    plt.tight_layout()
    plt.savefig('fig1_problem_gap_v3.png', dpi=300, bbox_inches='tight',
                facecolor='white', edgecolor='none')
    plt.savefig('fig1_problem_gap_v3.pdf', bbox_inches='tight',
                facecolor='white', edgecolor='none')
    print("Figure 1 saved: fig1_problem_gap_v3.png/pdf")
    plt.close()


# ============================================================================
# Figure 3: Data Pipeline (Updated)
# ============================================================================
def generate_figure3_pipeline():
    ...
    # ===== STAGE 3: PRETRAINING (50B) =====
    ax.add_patch(Rectangle((7.1, 7.5), 3.5, 2.2, fill=True,
                           facecolor=colors['pretrain'], edgecolor='#7b1fa2', linewidth=2))
    ax.text(8.85, 9.5, 'PRETRAINING: 50B', fontsize=10, fontweight='bold', ha='center', color='#7b1fa2')

    pretrain = [
        ('fMRI FM', '15B', '4D Swin MAE'),
        ('EEG FM', '15B', 'DIVER-XL'),
        ('Genomic FM', '15B', 'PRS-T'),
        ('Q-Former', '500M', 'Cross-Modal'),
    ]
    ...
    plt.tight_layout()
    plt.savefig('fig3_data_pipeline_v3.png', dpi=300, bbox_inches='tight',
                facecolor='white', edgecolor='none')
    plt.savefig('fig3_data_pipeline_v3.pdf', bbox_inches='tight',
                facecolor='white', edgecolor='none')
    print("Figure 3 saved: fig3_data_pipeline_v3.png/pdf")
    plt.close()


# ============================================================================
# Figure 4: 5-Year Roadmap (Updated for 50B)
# ============================================================================
def generate_figure4_roadmap():
    ...
    # ===== OBJECTIVE 1: 50B FM (Y1-Y2) =====
    y_base = 17
    ax.text(0.5, y_base+0.8, 'Obj 1: 50B FM', fontsize=9, fontweight='bold', color='#1565c0')

    draw_task_bar(y_base, 2, 10, 'Data Integration 70K', colors['obj1'])
    draw_task_bar(y_base-1, 5, 12, 'fMRI FM 15B', colors['obj1'])
    draw_task_bar(y_base-2, 8, 10, 'EEG FM 15B', colors['obj1'])
    draw_task_bar(y_base-3, 12, 8, 'Genomic FM 15B', colors['obj1'])
    draw_task_bar(y_base-4, 17, 6, 'Q-Former 500M', colors['obj1'])
    ...
    draw_task_bar(y_base, 48, 6, 'Distillation 50B->3B', colors['obj4'])
    ...
    plt.tight_layout()
    plt.savefig('fig4_gantt_roadmap_v3.png', dpi=300, bbox_inches='tight',
                facecolor='white', edgecolor='none')
    plt.savefig('fig4_gantt_roadmap_v3.pdf', bbox_inches='tight',
                facecolor='white', edgecolor='none')
    print("Figure 4 saved: fig4_gantt_roadmap_v3.png/pdf")
    plt.close()
...
if __name__ == '__main__':
    print("Generating NRF Proposal Figures v3 (50B Scale)...")
    print("=" * 50)
    ...
    print("\nGenerated files:")
    print("  - fig1_problem_gap_v3.png/pdf")
    print("  - fig2_model_architecture_v3.png/pdf")
    print("  - fig3_data_pipeline_v3.png/pdf")
    print("  - fig4_gantt_roadmap_v3.png/pdf")
